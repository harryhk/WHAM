...
// use OpenMP to do parallel 
#pragma omp parallel  default(shared) private(k,i,l,j,num, denom, bias, bf, bias_il_p, bias_ilk_p , bias_ilj_p, traj_bias_pi , traj_bias_pj, F_iter, kT_iter)
{
	#pragma omp for
